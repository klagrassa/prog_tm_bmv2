...
class Context final {
 ...
 public:
  ...
  // Added for the Traffic Manager part. Needs to have access to the actions
  // in a more efficient way without having the table name/id
  std::shared_ptr<P4Objects> get_p4objects() const { return p4objects; }
