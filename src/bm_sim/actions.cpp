...
// Part of traffic manager prototype
void 
ActionFn::update_extern_instance(ExternType *new_extern) {
  for (auto &param : params) {
    if (param.tag == ActionParam::EXTERN_INSTANCE) {
      param.extern_instance = new_extern;
    }
  }
}
